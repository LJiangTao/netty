...
public class ConnectionLoggingHandler extends ChannelDuplexHandler {
     ...
     */
    public ConnectionLoggingHandler() {
        this(DEFAULT_LEVEL);
    }
    /**
     * Creates a new instance whose logger name is the fully qualified class
     ...
     */
    public ConnectionLoggingHandler(ByteBufFormat format) {
     ...
     */
    public ConnectionLoggingHandler(LogLevel level) {
     ...
     */
    public ConnectionLoggingHandler(LogLevel level, ByteBufFormat byteBufFormat) {
     ...
     */
    public ConnectionLoggingHandler(Class<?> clazz) {
     ...
     * @param level the log level
     */
    public ConnectionLoggingHandler(Class<?> clazz, LogLevel level) {
     ...
     * @param byteBufFormat the ByteBuf format
     */
    public ConnectionLoggingHandler(Class<?> clazz, LogLevel level, ByteBufFormat byteBufFormat) {
     ...
     */
    public ConnectionLoggingHandler(String name) {
     ...
     * @param level the log level
     */
    public ConnectionLoggingHandler(String name, LogLevel level) {
     ...
     * @param byteBufFormat the ByteBuf format
     */
    public ConnectionLoggingHandler(String name, LogLevel level, ByteBufFormat byteBufFormat) {
